...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Assessment QaizenX &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="./" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
					...
					<p id="nav">
				<a class="wp-login-lost-password" href="./?action=lostpassword">Lost your password?</a>			</p>
			<script type="text/javascript">
/*  */
...
/*  */
		...
		<p id="backtoblog">
			<a href="./index.html">&larr; Go to Assessment QaizenX</a>		</p>
			</div>
...
/*  */
var userProfileL10n = {"user_id":"0","nonce":"11101733b6"};
/*  */
</script>
<script type="text/javascript" src="./wp-admin/js/user-profile.min.js?ver=6.7.1" id="user-profile-js"></script>
	</body>
	</html>